      ...
      <div class="col-md-10">
        <div class="d-flex p-3 text-black">
          <div class="p-2" style="margin: 0 auto;">
            <h3 class="text-center m-3">警告！彻底关闭不再使用的京东账号！</h3>
            <button class="btn btn-outline-danger btn-sm btn-block" onclick="delConfirm('确定要注销吗',
                      '${pageContext.request.contextPath}/admin/delete_change.safe','1','ajax_no')">注销</button>
          </div>
        </div>
      </div>
      <div class="col-md-1"></div>
